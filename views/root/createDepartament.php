        ...
        <div class="content-page-container full-reset custom-scroll-containers">
            ...
            <div class="container"> <!-- Quieto -->
                <div class="page-header"> <!-- Quieto -->
                  <h1 class="all-tittles"> Agregar Departamento <small> Departamentos</small> </h1>
              </div>
          </div>
        ...
        <div class="container-fluid"  style="margin: 0px 0;">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    En esta sección puede agregar un deparmento, llenando el formulario a continuación:
                </div>
                <br><br><br><br><br><br>
        <div class="container-fluid">
            <div class="container-flat-form">
                <div class="title-flat-form title-flat-red">Agregar departamento</div>
                <form autocomplete="off">
                    <div class="row">
                       <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                            <div class="group-material">
                                <input type="text" class="material-control tooltips-general" placeholder="Nombre de departamento" required="" maxlength="50" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,50}" data-toggle="tooltip" data-placement="top" title="Escriba el nombre del deparmento a agregar">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label>Nombre departamento</label>
                            </div>
                            <div class="group-material">
                                <input type="number" class="material-control tooltips-general" placeholder="Código carrera" required="" maxlength="20" data-toggle="tooltip" data-placement="top" title="Ingrese el código de su departamento">
                                <span class="highlight"></span>
                                <span class="bar"></span>
