...
<html lang="es">
<head>
    <title>Performance Evaluations - Listado de autoevaluaciones realizadas por los docentes</title>
    <!-- Meta -->
...
<body>
    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container nav-espacio">
            <h1 class="all-tittles">Ver autoevaluaciones realizadas por los docentes</h1>
        </div>
            ...
            <div class="container-fluid"  style="margin: 0px 0;">
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                        En esta sección puede visualizar la lista de autoevaluaciones realizadas por los docentes.
                    </div>
                        ...
                        <div class="container-flat-form">
                            ...
                            <div class="container-fluid"  style="margin: 50px 0;">
                                ...
                                <div class="group-material">
                                    ...
                                    <div class="group-material">                                                                                  
                                        <select onchange="cambiarResultadosAutoevaluacionesProfesores(this.value); this.selectedindex = -1"  class="form-control" id="periodoList">
                                        ...
                                        <form class="form-inline" action="../../include.php" method="post">
                                            <input type="hidden" name="solicitud" value="generate_pdf_rap">
