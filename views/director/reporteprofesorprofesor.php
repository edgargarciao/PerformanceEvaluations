...
<html lang="es">
<head>
    <title>Performance Evaluations - Listado de evaluciones realizadas de docentes a docentes</title>
    <!-- Meta -->
...
<body>
    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container nav-espacio">
            <h1 class="all-tittles">Ver evaluaciones de pares</h1>
        </div>
            ...
            <div class="container-fluid"  style="margin: 0px 0;">
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                        En esta sección puede visualizar la lista de evaluaciones realizadas por de docente a docente (Pares) y la nota es tomada del promedio de todas las calificaciones que ha obtenido dicho profesor.
                    </div>
                    <div class="container-fluid contai-espacio">
                        <div class="container-flat-form">
                            <div class="title-flat-form title-flat-red">Evaluaciones de pares</div>
                            <div class="container-fluid"  style="margin: 50px 0;">
                                ...
                                <div class="group-material">
                                    ...
                                    <div class="group-material">                                                                                  
                                        <select onchange="cambiarResultadosProfesorProfesor(this.value); this.selectedindex = -1" class="form-control" id="periodoList">
                                        </select>                                      
                                    </div>
