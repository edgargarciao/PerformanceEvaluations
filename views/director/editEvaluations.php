...
<body>
    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container nav-espacio">
            <h1 class="all-tittles">Administración de los criterios</h1>
        </div>
            ...
            <div class="container-fluid"  style="margin: 0px 0;">
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                        En esta sección puede el director editar el contenido de los criterios de la evaluación, asi como deshabilitar/habilitar algunos de estos criterios y agregar nuevos criterios.
                    </div>
                    <div class="container-fluid contai-espacio">
                        <div class="container-flat-form">
                            <div class="title-flat-form title-flat-red">Administrar criterios
                            </div>
                            <div class="container-fluid"  style="margin: 50px 0;">
                                <div class="row">
                                    ...
                                    <div class="col-xs-12">
                                        <div class="table-responsive">
                                            <div id = "criterios" method="post">
                                                    ...
                                                    <table id="dataTables-example" class="table table-striped text-center" border="1"style="border: #8080802e 1px solid">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td class="text-center" id="nombre">Profesor-profesor</td>
                                        ...
                                        <div>
                                            <a href="#" class="btn btn-primary" data-toggle="modal" data-target=".myModal2">Añadir nuevo criterio
                                            </a> 
                                        </div>
                                    </div>
                                    </form>
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                                    ...
                                    <input type="hidden" name="t" class="material-control tooltips-general" required="" maxlength="50" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,50}" data-toggle="tooltip">
                                        ...
                                        <span class="bar"></span>
                                        <label>Escoge el tipo de evaluacion</label>
                                    </div>

                                    <div class="group-material">                                                                                  
                                        <select class="form-control" name="tipoEvaluacion">
                                            <option value="1">Director-profesor</option>
                                            <option value="2">Profesor-profesor</option>
                                            <option value="3">Autoevalucion profesor</option>
                                            <option value="4">Autoevaluacion director</option>
                                        </select>                                      
                                    </div>
                                    <div class="group-material">
                                        <input type="text" name="criterio" class="material-control tooltips-general" placeholder="Nuevo criterio" required="" data-toggle="tooltip">
                                        <span class="highlight"></span>
                                        <span class="bar"></span>
                                        <label>Nombre del criterio</label>
                                    </div>
                                    <p class="text-center">
                                            <input type="hidden" name="solicitud" value="registryCriterio">
