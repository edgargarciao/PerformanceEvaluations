...
<body>
                        ...
                        <div class="container-flat-form">
                            ...
                            <div class="container-fluid"  style="margin: 50px 0;">
                                ...
                                <div class="group-material">
                                    ...
                                    <div class="group-material">                                                                                  
                                        <select onchange="cambiarResultadosAutoevaluacionDocente(this.value); this.selectedindex = -1" class="form-control" id="periodoList">
 ...
 <?php include 'General/down.php';?>
    ...
    <?php 
        echo '<script type="text/javascript"> cargarAutoevaluacionDocente(); </script>';
    ?>
</body>
</html>