...
<body>
    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container nav-espacio">
            <h1 class="all-tittles">Ver evaluaciones realizadas</h1>
        </div>
            ...
            <div class="container-fluid"  style="margin: 0px 0;">
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                        En esta sección puede visualizar la lista de evaluaciones realizadas por periodo.
                    </div>
                    <div class="container-fluid contai-espacio">
                        <div class="container-flat-form">
                            <div class="title-flat-form title-flat-red">Evaluaciones</div>
